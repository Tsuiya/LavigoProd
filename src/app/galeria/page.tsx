...
const portfolioPhotos: PortfolioPhoto[] = [
  // Casamento Civil - Larissa e Rodolfo
  {
    ...
    title: "Cumplicidade",
    alt: "Noivos trocando olhares afetuosos no casamento civil"
  },
  {
    ...
    alt: "Abraço sincero dos noivos Larissa e Rodolfo"
  },
  {
    ...
    alt: "Noiva assinando a certidão de casamento civil"
  },
  {
    ...
    alt: "Noivos brindando o casamento civil com champagne"
  },
  ...
  },
  {
    ...
    alt: "Noivos assinando papéis do casamento civil"
  },
  {
    ...
    alt: "Noivos de mãos dadas em prece"
  },
  ...
  // Casamento Religioso - Camila e Sidney
  {
    ...
    alt: "Still de filme do casamento de Camila e Sidney no altar"
  },
  {
    ...
    tag: "Camila & Sidney · Religioso",
    title: "O Sim",
    alt: "Still cinematográfico de Camila e Sidney se unindo no altar"
  },
  {
    ...
    tag: "Camila & Sidney · Religioso",
    title: "As Alianças",
    alt: "Troca de alianças sob luz poética da igreja"
  },
  {
    ...
    alt: "Saída dos noivos Camila e Sidney celebrando o beijo"
  },
  ...
  // Ensaio Infantil - Agatha
  {
    ...
    alt: "Ensaio infantil temático de natal de Agatha"
  },
  {
    ...
    alt: "Ensaio infantil de Agatha com 6 meses de idade"
  },
  ...
  // Aniversário - Luisa
  {
    ...
    title: "Luisa · 2 Anos",
    alt: "Retrato do aniversário de 2 anos da pequena Luisa"
  },
  {
    ...
    alt: "Momento dos parabéns de Luisa em sua festa"
  }
];
    ...
    <main style={{ paddingTop: "8rem" }}>
      <section className="page-hero">
        ...
        <p className="page-hero-desc reveal d3">
          Veja nossa coleção de memórias reais capturadas com amor e atenção sutil. Filtre pelas categorias para explorar nosso acervo de histórias.
        </p>
      </section>
