    ...
    <main style={{ paddingTop: "8rem" }}>
      ...
      <section className="page-hero">
        ...
        <p className="page-hero-desc reveal d3">
          ...
          Estamos aqui para acompanhar a trajetória da sua família no seu próprio ritmo, sendo uma alternativa afetiva para guardar cada um dos seus melhores momentos.
        </p>
      </section>
      ...
      <section id="cta-final" style={{ backgroundColor: "var(--bg-secondary)", borderTop: "none" }}>
        <div className="cta-container reveal">
          <h2 className="cta-heading" style={{ fontSize: "3rem" }}>
            "Os momentos que definem quem você é merecem um registro físico de respeito."
          </h2>
          <p className="cta-sub">Escolha ter um registro completo da sua trajetória familiar com toda a leveza e cuidado que sua história merece.</p>
