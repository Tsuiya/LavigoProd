    ...
    <main style={{ paddingTop: "8rem" }}>
      <section className="page-hero">
        ...
        <p className="page-hero-desc reveal d3">
          Acompanhamos sua história familiar em cada etapa. Da cumplicidade do casal ao primeiro filho, do nascimento ao crescimento anual, registramos memórias reais com sensibilidade documental.
        </p>
      </section>
      ...
      <section id="cta-final" style={{ backgroundColor: "var(--bg-secondary)", borderTop: "none" }}>
        <div className="cta-container reveal">
          <h2 className="cta-heading" style={{ fontSize: "3rem" }}>
            "Registrar o presente é desenhar a ponte para a saudade do futuro."
          </h2>
          <p className="cta-sub">Tem um projeto em mente? Entre em contato e monte um pacote personalizado.</p>
