...
const faqs: FAQItem[] = [
  {
    ...
    a: "Nossa sede é em Ibitinga, SP, mas cobrimos toda a região do interior paulista (como Araraquara, Bauru, Jaú, Ribeirão Preto e São Carlos). Também estamos disponíveis para viagens nacionais e casamentos fora do estado."
  },
  {
    ...
    <main style={{ paddingTop: "8rem" }}>
        ...
        <div className="sobre-grid">
          <div className="sobre-text-wrapper reveal d1">
            ...
            <p className="sobre-paragraph">
              Localizados em Ibitinga, SP, nos especializamos em criar registros elegantes e sem exageros artificiais. Não vendemos arquivos digitais frios ou álbuns cheios de efeitos especiais digitais. Vendemos a lembrança tangível do abraço do seu parceiro antes de subirem ao altar, do tamanho da mão do seu bebê nas primeiras duas semanas e da cumplicidade do seu lar.
            </p>
            <p className="sobre-paragraph">
              Para nós, cada clique é feito pensando no dia em que seus netos vão folhear o álbum de vocês, sentindo a mesma emoção que foi vivida hoje.
            </p>
          </div>
      ...
      <section id="cta-final" style={{ backgroundColor: "var(--bg)", borderTop: "none" }}>
        <div className="cta-container reveal">
          ...
          <p className="cta-sub">Estamos localizados em Ibitinga, SP, mas podemos ir até você.</p>
